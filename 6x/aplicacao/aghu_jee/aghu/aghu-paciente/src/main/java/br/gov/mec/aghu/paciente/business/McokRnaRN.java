 ...
 */
@Stateless
public class McokRnaRN extends BaseBusiness {

private static final Log LOG = LogFactory.getLog(McokRnaRN.class);
...
return LOG;
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1450160374589592454L;

	public void setvVeioTrocaPac(Boolean vVeioTrocaPac) {
	//	this.atribuirContextoSessao(VariaveisSessaoEnum.MCOK_RNA_RN_V_VEIO_TROCA_PAC, vVeioTrocaPac);
	}
