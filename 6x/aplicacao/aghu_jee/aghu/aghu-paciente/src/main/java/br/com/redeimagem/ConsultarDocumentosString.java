 ...
 *         &lt;element name="ficha" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "ConsultarDocumentosString")
public class ConsultarDocumentosString {
     ...
     * 
     */
    public void setFicha(int value) {
        this.ficha = value;
    }
