 ...
 */
@Stateless
public class McokBsrRN extends BaseBusiness {

private static final Log LOG = LogFactory.getLog(McokBsrRN.class);
...
return LOG;
	 ...
	 * 
	 */
	private static final long serialVersionUID = -908035169438761178L;

	public void setvVerDtRomp(Boolean vVerDtRomp) {
	//	this.atribuirContextoSessao(VariaveisSessaoEnum.MCOK_BSR_RN_V_VER_DT_ROMP, vVerDtRomp);
	}
