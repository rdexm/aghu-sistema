 ...
 */
@Stateless
public class McokNasRN extends BaseBusiness {

private static final Log LOG = LogFactory.getLog(McokNasRN.class);
...
return LOG;
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8626640716789661445L;

	public void setvVeioTrocaPac(Boolean vVeioTrocaPac) {
	//	this.atribuirContextoSessao(VariaveisSessaoEnum.MCOK_NAS_RN_V_VEIO_TROCA_PAC, vVeioTrocaPac);
	}
