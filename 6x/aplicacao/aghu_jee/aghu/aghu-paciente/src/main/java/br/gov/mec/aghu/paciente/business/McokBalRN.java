 ...
 */
@Stateless
public class McokBalRN extends BaseBusiness {

private static final Log LOG = LogFactory.getLog(McokBalRN.class);
...
return LOG;
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2286491745289710419L;

	public void setvVeioSubsGestaBal(Boolean vVeioSubsGestaBal) {
	//	this.atribuirContextoSessao(VariaveisSessaoEnum.MCOK_BAL_RN_V_VEIO_SUBS_GESTA_BAL, vVeioSubsGestaBal);
	}
