...
public class CursorCRapVOQueryBuilder extends QueryBuilder<DetachedCriteria> {
	...
	private void setFiltro() {
		...
		criteria.add(Restrictions.eq(ALIAS_SER+"."+RapServidores.Fields.VIN_CODIGO.toString(), this.matricula));
	}
	
	private void setProjecao() {
		criteria.setProjection(Projections.property(ALIAS_PES+"."+RapPessoasFisicas.Fields.NOME.toString()));
