...
class ConsultarInfoProcCirgReqOPMEQueryBuilder extends QueryBuilder<DetachedCriteria> {
	/**
	 * 
	 */
	...
	private void setFiltro() {
		...
		criteria.add(Restrictions.not(Restrictions.eq(ALIAS_CRG + PONTO + MbcCirurgias.Fields.SITUACAO.toString(), 
