...
public class PesquisaPacientePorCodigoListener implements ValueChangeListener {
	...
	public void processValueChange(ValueChangeEvent event) throws AbortProcessingException {
		...
		try {
			if (newValue != null) {
				_paciente = this.getPacienteFacade().obterPacientePorCodigo(newValue);
				...
				if (_paciente != null) {
					...
					//TODO
					String mensagem = WebUtil.initLocalizedMessage("MENSAGEM_PACIENTE_CODIGO_NAO_ENCONTRADO",null, newValue.toString());
					...
					//		"MENSAGEM_PACIENTE_CODIGO_NAO_ENCONTRADO", newValue.toString());
				}
			} else {
				PropertyUtils.setProperty(controller, parametroCodigo, null);
				PropertyUtils.setProperty(controller, parametroProntuario, null);
