...
public class RelatorioCirurgiasReservaHemoterapicaController extends ActionReport {
	...
	private List<RelatorioCirurgiasReservaHemoterapicaVO> colecao;
	
	private String nomeMicrocomputador;
 
	private static final Log LOG = LogFactory.getLog(RelatorioCirurgiasReservaHemoterapicaController.class);
	
	private static final String RELATORIO_CIR_RESERV_HEMOTERAPICA_PDF = "relatorioCirurgiasReservaHemoterapicaPdf";
	private static final String RELATORIO_CIR_RESERV_HEMOTERAPICA = "relatorioCirurgiasReservaHemoterapica";
	...
	public String recuperarArquivoRelatorio() {
		return "br/gov/mec/aghu/blococirurgico/report/relatorioCirurgiasReservaHemoterapica.jasper";
	}
	 ...
	 */
	@Override
	public Collection<RelatorioCirurgiasReservaHemoterapicaVO> recuperarColecao() throws ApplicationBusinessException {		
		return colecao; 
	}
	
	public void carregarColecao() throws ApplicationBusinessException{		
			colecao = blocoCirurgicoFacade.recuperarRelatorioCirurgiasReservaHemoterapicaVO(unidadeCirurgica.getSeq(), dataCirurgia, cirgComSolicitacao);			
	}
	...
	public String print()throws JRException, IOException, DocumentException{
		...
		return RELATORIO_CIR_RESERV_HEMOTERAPICA_PDF;
		} catch (ApplicationBusinessException e) {
			apresentarExcecaoNegocio(e);
			return null;
		}		
	...
	public String voltar() {
		return RELATORIO_CIR_RESERV_HEMOTERAPICA;
	}
	...
	public List<RelatorioCirurgiasReservaHemoterapicaVO> getColecao() {
		return colecao;
	}

	public void setColecao(List<RelatorioCirurgiasReservaHemoterapicaVO> colecao) {
