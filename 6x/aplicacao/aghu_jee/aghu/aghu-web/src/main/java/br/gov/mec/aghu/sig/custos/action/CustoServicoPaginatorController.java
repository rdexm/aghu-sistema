...
public class CustoServicoPaginatorController extends ActionController {
	
	private List<VisualizarAnaliseTabCustosObjetosCustoVO> lista;

	private static final Log LOG = LogFactory.getLog(CustoServicoPaginatorController.class);

	private static final long serialVersionUID = -8346981833567448418L;
	...
	public void pesquisar(){
		 this.lista = custosSigCadastrosBasicosFacade.buscarMovimentosServicos(this.seqCompetencia, this.seqObjetoCustoVersao, this.seqCentroCusto, this.tipoVisaoAnaliseItens);
	}
