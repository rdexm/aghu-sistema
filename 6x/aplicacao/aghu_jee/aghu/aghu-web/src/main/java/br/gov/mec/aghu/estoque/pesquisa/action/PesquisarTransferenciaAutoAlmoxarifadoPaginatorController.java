...
public class PesquisarTransferenciaAutoAlmoxarifadoPaginatorController extends ActionController implements ActionPaginator {
	...
	private static final String GERAR_TRANSFERENCIA_AUTO_ALMOXARIFADO = "estoque-gerarTransferenciaAutoAlmoxarifado";
	...
	public String editar(){
		return GERAR_TRANSFERENCIA_AUTO_ALMOXARIFADO;
	}
