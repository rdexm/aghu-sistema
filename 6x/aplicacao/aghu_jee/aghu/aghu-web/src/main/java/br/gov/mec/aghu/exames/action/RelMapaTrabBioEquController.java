...
public class RelMapaTrabBioEquController extends ActionReport {
	...
	private static final Log LOG = LogFactory.getLog(RelMapaTrabBioEquController.class);

	private static final String EMISSAO_MAPA_TRABALHO = "exames-emissaoMapaTrabalho";

	private static final long serialVersionUID = -5289119987368341859L;
	...
	public String recuperarArquivoRelatorio() {
		return "br/gov/mec/aghu/exames/report/relatorioMapaBioquimicaEQU.jasper";
	}
