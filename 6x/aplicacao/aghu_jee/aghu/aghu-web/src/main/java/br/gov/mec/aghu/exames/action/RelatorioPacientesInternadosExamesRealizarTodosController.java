...
public class RelatorioPacientesInternadosExamesRealizarTodosController  extends ActionReport {
	...
	private static final long serialVersionUID = -3393929798944614621L;
	
	private final static String ARQUIVO_JASPER = "br/gov/mec/aghu/exames/report/relatorioPacientesInternadosExamesRealizarTodos.jasper";
	private final static String TITULO_RELATORIO = "Relação de Pacientes Internados com exames a realizar (Todos)";
	...
	public Map<String, Object> recuperarParametros() {
		...
		params.put("nomeRelatorio", DominioNomeRelatorio.AELR_EXME_A_REAL_PAC.toString());
	...
	public void directPrint() throws SistemaImpressaoException, ApplicationBusinessException  {
		try {
			...
			if(impressao && this.colecao.isEmpty()){
				this.apresentarMsgNegocio(Severity.INFO, "MENSAGEM_ARQUIVO_IMPRESSAO_EM_BRANCO", "Todos os pacientes");
				return;
			}
