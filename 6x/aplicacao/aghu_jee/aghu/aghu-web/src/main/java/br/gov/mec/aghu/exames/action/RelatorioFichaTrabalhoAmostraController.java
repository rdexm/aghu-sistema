...
public class RelatorioFichaTrabalhoAmostraController extends ActionReport {
	...
	private static final String RELATORIO_FICHA_TRABALHO_AMOSTRA = "relatorioFichaTrabalhoAmostra";
	private static final String RELATORIO_FICHA_TRABALHO_AMOSTRA_PDF = "relatorioFichaTrabalhoAmostraPdf";
	...
	public String voltar(){
		return RELATORIO_FICHA_TRABALHO_AMOSTRA;
	}
	...
	public String print() throws BaseException, JRException, SystemException, IOException, DocumentException {
		...
		return RELATORIO_FICHA_TRABALHO_AMOSTRA_PDF;
	}
	...
	public Map<String, Object> recuperarParametros() {
		...
		String subReport = "br/gov/mec/aghu/exames/report/relatorioFichaTrabAmo_Exames.jasper";
		...
		params.put("nomeRelatorio", "AELR_FICHA_TRAB_ARF");
	...
	public Collection<RelatorioFichaTrabalhoPatologiaVO> recuperarColecao() throws ApplicationBusinessException {
		...
		colecao.add(this.examesFacade.obterFichaTrabAmostra(soeSeq, amostra, unidadeExecutora.getSeq()));
		return this.colecao;
	}

	@Override
	public String recuperarArquivoRelatorio() {
		return "br/gov/mec/aghu/exames/report/relatorioFichaTrabAmo.jasper";
	}
	...
	public List<RelatorioFichaTrabalhoPatologiaVO> getColecao() {
		return colecao;
	}

	public void setColecao(List<RelatorioFichaTrabalhoPatologiaVO> colecao) {
