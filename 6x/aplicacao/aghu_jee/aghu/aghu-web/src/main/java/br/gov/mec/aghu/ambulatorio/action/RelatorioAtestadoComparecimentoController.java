...
public class RelatorioAtestadoComparecimentoController extends ActionReport {

	private static final long serialVersionUID = 2921505139716177722L;
	
	private static final Log LOG = LogFactory.getLog(RelatorioAtestadoComparecimentoController.class);
	...
	private MamTipoAtestado atestadoComparecimento = new MamTipoAtestado();
	
	public void recuperaTipoAteChavePrimaria(){
		 tipoAtestados = ambulatorioFacade.listarTodos();
		   for(MamTipoAtestado tipoComparecimento : tipoAtestados){
			   if(tipoComparecimento.getDescricao().equalsIgnoreCase("Atestado de Comparecimento")){
				   atestadoComparecimento = tipoComparecimento;
			   }
		   }
	}
	...
	public void recuperarAtestado(AacConsultas consNumero, Long idAtestado) throws ApplicationBusinessException {
		...
		atestadoAmbulatorio.setMamTipoAtestado(atestadoComparecimento);
	...
	public String recuperarArquivoRelatorio() {
		return "br/gov/mec/aghu/ambulatorio/report/atestadoComparecimento.jasper";
	}
