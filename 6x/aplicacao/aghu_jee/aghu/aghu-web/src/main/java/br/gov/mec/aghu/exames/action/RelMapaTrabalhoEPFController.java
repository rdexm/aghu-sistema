...
public class RelMapaTrabalhoEPFController extends ActionReport {
	...
	private static final Log LOG = LogFactory.getLog(RelMapaTrabalhoEPFController.class);
	...
	private List<RelatorioMapaEpfVO> lista;
	...
	@Override
	public List<RelatorioMapaEpfVO> recuperarColecao() throws ApplicationBusinessException {
		if(errorEmptyList){ return null; }
		...
		if(lista == null){
			...
			try {
				lista = examesFacade.obterMapasEpfVO(mapa, tipoImpressao, dataMapa, nroMapa, nomeMicrocomputador);
			} catch (BaseException e) {
				apresentarExcecaoNegocio(e);
			}
...
//			}
	...
	public String recuperarArquivoRelatorio() {
		return "br/gov/mec/aghu/exames/report/relatorioMapaEpf.jasper";
	}
	...
	public List<RelatorioMapaEpfVO> getLista() {
		return lista;
	}

	public void setLista(List<RelatorioMapaEpfVO> lista) {
		this.lista = lista;
	}
