...
public class ParametroListFinalReportGenerator extends AghuReportGenerator {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7180425154804364102L;
	...
	public String recuperarArquivoRelatorio() {
		return "/br/gov/mec/aghu/parametrosistema/report/relatorioParametrosSistemaFinal.jasper";
	}
	...
	public Map<String, Object> recuperarParametros() {
		...
		params.put("nomeRelatorio", "AGH_PARAMETROS_REL_FINAL");
		params.put("tituloRelatorio", "Relatório de Parametros de Sistema - Final");
