...
/**
 * Classe controle da tela Cadastrar Motivos de Saída de Pacientes
 * 
 * @author rafael.silvestre
 */
public class MotivoSaidaPacienteController extends ActionController {

	private static final long serialVersionUID = 3169791638831217939L;
	...
	private static final String MENSAGEM_SUCESSO_INCLUSAO = "MENSAGEM_SUCESSO_INCLUSAO_MOTIVO_SAIDA_PACIENTE";

	@EJB
	private IFaturamentoApoioFacade faturamentoApoioFacade;
	
	private FatMotivoSaidaPaciente entity;
	...
	private void limpar() {
		...
		if (this.modoEdicao) {
			...
			this.situacao = true;
			this.entity = new FatMotivoSaidaPaciente();
		}
	}
	...
	public void gravar() {
		...
		try {
			...
			this.faturamentoApoioFacade.gravarMotivoSaidaPaciente(this.entity);
	 ...
	 * 
	 */
	public FatMotivoSaidaPaciente getEntity() {
		return entity;
	}

	public void setEntity(FatMotivoSaidaPaciente entity) {
		this.entity = entity;
	}
