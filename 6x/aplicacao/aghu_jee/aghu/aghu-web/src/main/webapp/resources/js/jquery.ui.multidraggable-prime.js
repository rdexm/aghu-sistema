...
jQuery.widget("ui.multidraggable", jQuery.extend({}, jQuery.ui.draggable.prototype, {
	_create: function() {
	...
	_mouseStart: function(event) {
		...
		if (this.element.hasClass('ui-multidraggable')) {
			...
			jQuery(".ui-multidraggable").each(function () { jQuery(this).multidraggable("mouseStart", event, o); });
			return true;
		} else {
	...
	_mouseDrag: function(event, noPropagation) {
		if (this.element.hasClass('ui-multidraggable')) {
			jQuery(".ui-multidraggable").each(function () { jQuery(this).multidraggable("mouseDrag", event, noPropagation); });
			return false;
		} else {
	...
	_mouseStop: function(event) {
		if (this.element.hasClass('ui-multidraggable')) {
			jQuery(".ui-multidraggable").each(function () { jQuery(this).multidraggable("mouseStop", event); });
			return false;
		} else {
...
jQuery.extend(jQuery.ui.multidraggable, {
	version: "1.8.8",
...
jQuery.ui.plugin.add("multidraggable", "connectToSortable", {
	start: function(event, ui) {

		var inst = jQuery(this).data("multidraggable"), o = inst.options,
	...
	stop: function(event, ui) {
		...
		var inst = jQuery(this).data("multidraggable"),
			uiSortable = jQuery.extend({}, ui, { item: inst.element });
	...
	drag: function(event, ui) {
		...
		var inst = jQuery(this).data("multidraggable"), self = this;
...
jQuery.ui.plugin.add("multidraggable", "cursor", {
	start: function(event, ui) {
		if (jQuery(this).hasClass('ui-multidraggable')) {
			if (jQuery(this).data('multidraggable').options.isMain == false) {
				return;
			}
		}
		var t = jQuery('body'), o = jQuery(this).data('multidraggable').options;
	...
	stop: function(event, ui) {
		...
		var o = jQuery(this).data('multidraggable').options;
		if (o._cursor) jQuery('body').css("cursor", o._cursor);
	}
});

jQuery.ui.plugin.add("multidraggable", "iframeFix", {
	start: function(event, ui) {
		var o = jQuery(this).data('multidraggable').options;
...
jQuery.ui.plugin.add("multidraggable", "opacity", {
	start: function(event, ui) {
		var t = jQuery(ui.helper), o = jQuery(this).data('multidraggable').options;
...
jQuery.ui.plugin.add("multidraggable", "scroll", {
	start: function(event, ui) {
		var i = jQuery(this).data("multidraggable");
		if(i.scrollParent[0] != document && i.scrollParent[0].tagName != 'HTML') i.overflowOffset = i.scrollParent.offset();
	},
	drag: function(event, ui) {

		var i = jQuery(this).data("multidraggable"), o = i.options, scrolled = false;
...
jQuery.ui.plugin.add("multidraggable", "snap", {
	start: function(event, ui) {

		var i = jQuery(this).data("multidraggable"), o = i.options;
		i.snapElements = [];
...
jQuery.ui.plugin.add("multidraggable", "stack", {
	start: function(event, ui) {
		...
		if (jQuery(this).hasClass('ui-multidraggable')) {
			if (jQuery(this).data('multidraggable').options.isMain == true) {
...
jQuery.ui.plugin.add("multidraggable", "zIndex", {
	start: function(event, ui) {
		var t = jQuery(ui.helper), o = jQuery(this).data("multidraggable").options;
