...
public class ExameInternetStatusJob extends AghuJob {
	
	private static final Log LOG = LogFactory.getLog(ExameInternetStatusJob.class);
	...
	protected void doExecutarProcessoNegocio(AghJobDetail job, JobExecutionContext jobExecutionContext) throws ApplicationBusinessException {
		LOG.info("Executando processo de negocio - solicitacaoExame - inserirFilaExamesLiberados.");
		solicitacaoExameFacade.inserirFilaExamesLiberados(job);
