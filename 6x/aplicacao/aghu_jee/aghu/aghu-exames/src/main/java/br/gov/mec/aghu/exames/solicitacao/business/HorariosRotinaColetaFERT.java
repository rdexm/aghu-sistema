...
@Stateless
public class HorariosRotinaColetaFERT extends HorariosRotinaColeta {
	
	private static final Log LOG = LogFactory.getLog(HorariosRotinaColetaFERT.class);
	...
	public List<DataProgramadaVO> getHorariosRotinaColeta(AghUnidadesFuncionais unidadeSolicitante, AghUnidadesFuncionais unfSeqAvisa, Date dataHoraAtual, Date dataHoraLimite) {
		List<AelHorarioRotinaColetas> horariosRotina = getAelHorarioRotinaColetasDAO().obterAelHorarioRotinaColetasFeriadoTarde(unidadeSolicitante, unfSeqAvisa, dataHoraAtual);
