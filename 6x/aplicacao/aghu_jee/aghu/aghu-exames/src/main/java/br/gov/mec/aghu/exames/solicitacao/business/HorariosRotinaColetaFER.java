...
@Stateless
public class HorariosRotinaColetaFER extends HorariosRotinaColeta {

	private static final Log LOG = LogFactory.getLog(HorariosRotinaColetaFER.class);
	...
	public List<DataProgramadaVO> getHorariosRotinaColeta(AghUnidadesFuncionais unidadeSolicitante, AghUnidadesFuncionais unfSeqAvisa, Date dataHoraAtual, Date dataHoraLimite) {
		List<AelHorarioRotinaColetas> horariosRotina = getAelHorarioRotinaColetasDAO().obterAelHorarioRotinaColetasFeriado(unidadeSolicitante, unfSeqAvisa, dataHoraAtual);
