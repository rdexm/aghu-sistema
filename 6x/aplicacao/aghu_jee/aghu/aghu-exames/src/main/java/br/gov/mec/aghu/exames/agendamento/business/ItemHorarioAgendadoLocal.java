...
@Local
public interface ItemHorarioAgendadoLocal {

	void gravarHorario(List<ItemHorarioAgendadoVO> listaItemHorarioAgendadoVO,
			VAelHrGradeDispVO vAelHrGradeDispVO, String nomeMicrocomputador,
			List<AgendamentoExameVO> examesAgendamentoSelecao) throws BaseException;
