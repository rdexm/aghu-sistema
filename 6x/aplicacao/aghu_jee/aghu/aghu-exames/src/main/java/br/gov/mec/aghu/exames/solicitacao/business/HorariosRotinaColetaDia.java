...
@Stateless
public class HorariosRotinaColetaDia extends HorariosRotinaColeta {

	private static final Log LOG = LogFactory.getLog(HorariosRotinaColetaDia.class);
	...
	public List<DataProgramadaVO> getHorariosRotinaColeta(AghUnidadesFuncionais unidadeSolicitante, AghUnidadesFuncionais unfSeqAvisa, Date dataHoraAtual, Date dataHoraLimite) {
		List<AelHorarioRotinaColetas> horariosRotina = getAelHorarioRotinaColetasDAO().obterAelHorarioRotinaColetasDAO(unidadeSolicitante, unfSeqAvisa, dataHoraAtual);
