...
public class BuscaJustificativaLaudoCsaVO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1134939520487414628L;

	private Integer sheSeq;

	private String justificativa;

	public BuscaJustificativaLaudoCsaVO() {
	}

	public BuscaJustificativaLaudoCsaVO(Integer sheSeq, String justificativa) {
		this.sheSeq = sheSeq;
	...
	public boolean equals(Object obj) {
		...
		BuscaJustificativaLaudoCsaVO other = (BuscaJustificativaLaudoCsaVO) obj;
