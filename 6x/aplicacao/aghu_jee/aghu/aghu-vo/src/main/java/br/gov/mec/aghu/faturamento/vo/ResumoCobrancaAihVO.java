...
public class ResumoCobrancaAihVO {
	...
	private List<ResumoCobrancaAihServicosVO> listaServicos;	
...
//		}
	...
	public List<ResumoCobrancaAihServicosVO> getListaServicos() {
		return listaServicos;
	}

	public void setListaServicos(List<ResumoCobrancaAihServicosVO> listaServicos) {
	...
	public BigDecimal getTotalSH() {
		...
		for(ResumoCobrancaAihServicosVO servico : listaServicos) {
