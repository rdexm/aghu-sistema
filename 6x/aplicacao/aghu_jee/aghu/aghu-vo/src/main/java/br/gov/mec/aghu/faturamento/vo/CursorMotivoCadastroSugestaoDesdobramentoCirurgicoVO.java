...
public class CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO implements
		Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4227396579561260253L;
	...
	public CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO() {
	}

	public CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO(Byte seq,
			Short diasAposInternacao, Short qtdMinima,
			Short diasAposProcedimento,
			DominioMotivoDesdobramento tipoDesdobramento, Byte codigoSus) {
		this.seq = seq;
	...
	public CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO(Short seq,
			Short diasAposInternacao, Short qtdMinima,
			Short diasAposProcedimento,
			DominioMotivoDesdobramento tipoDesdobramento, Byte codigoSus) {

		this(seq.byteValue(), diasAposInternacao, qtdMinima, diasAposProcedimento, tipoDesdobramento, codigoSus);
	...
	public void setTipoDesdobramento(
			DominioMotivoDesdobramento tipoDesdobramento) {
		this.tipoDesdobramento = tipoDesdobramento;
	}
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((codigoSus == null) ? 0 : codigoSus.hashCode());
		result = prime
				* result
				+ ((diasAposInternacao == null) ? 0 : diasAposInternacao
						.hashCode());
		result = prime
				* result
				+ ((diasAposProcedimento == null) ? 0 : diasAposProcedimento
						.hashCode());
		result = prime * result
				+ ((qtdMinima == null) ? 0 : qtdMinima.hashCode());
		result = prime * result + ((seq == null) ? 0 : seq.hashCode());
		result = prime
				* result
				+ ((tipoDesdobramento == null) ? 0 : tipoDesdobramento
						.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO other = (CursorMotivoCadastroSugestaoDesdobramentoCirurgicoVO) obj;
		if (codigoSus == null) {
