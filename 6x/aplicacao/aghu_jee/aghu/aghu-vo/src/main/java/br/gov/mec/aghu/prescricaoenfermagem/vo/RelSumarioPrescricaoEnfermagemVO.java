...
public class RelSumarioPrescricaoEnfermagemVO{
	...
	public RelSumarioPrescricaoEnfermagemVO(Date data, String descricao,
			String valor, DominioTipoItemPrescricaoSumario tipo) {	
		super();
		this.data = data;
	...
	public boolean equals(Object obj) {
		...
		RelSumarioPrescricaoEnfermagemVO other = (RelSumarioPrescricaoEnfermagemVO) obj;
		if (data == null) {
			if (other.data != null) {
				return false;
			}
