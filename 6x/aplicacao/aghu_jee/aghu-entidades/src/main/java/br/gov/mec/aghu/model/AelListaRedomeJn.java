...
@Entity
@Table(name = "AEL_LISTA_REDOMES_JN", schema = "AGH")
@Immutable
public class AelListaRedomeJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 7731329610040393432L;
	...
	public AelListaRedomeJn() {
	}

	public AelListaRedomeJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public AelListaRedomeJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Integer serMatriculaProf,
			Short serVinCodigoProf, Date criadoEm, Integer serMatricula, Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
