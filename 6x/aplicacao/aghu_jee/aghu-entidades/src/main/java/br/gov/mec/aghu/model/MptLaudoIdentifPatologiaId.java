...
/**
 * MptLaudoIdentifPatologiaId generated by hbm2java
 */
@Embeddable
public class MptLaudoIdentifPatologiaId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4488008068896799551L;
	private Integer lauTrpSeq;
	private Short lauSeqp;

	public MptLaudoIdentifPatologiaId() {
	}

	public MptLaudoIdentifPatologiaId(Integer lauTrpSeq, Short lauSeqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MptLaudoIdentifPatologiaId)) {
			return false;
		}
		MptLaudoIdentifPatologiaId other = (MptLaudoIdentifPatologiaId) obj;
