...
/**
 * CseRefCode generated by hbm2java
 */
@Entity
@Table(name = "CSE_REF_CODES", schema = "AGH")
public class CseRefCode extends BaseEntityId<CseRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4004165873251111175L;
	private CseRefCodeId id;

	public CseRefCode() {
	}

	public CseRefCode(CseRefCodeId id) {
		this.id = id;
	}
	...
	public CseRefCodeId getId() {
		return this.id;
	}

	public void setId(CseRefCodeId id) {
		this.id = id;
	}
