 ...
 */
@Embeddable
public class ScoHistoricoOcorrFornId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 394904915599692553L;
	private Integer frnNumero;
	private Short numero;

	public ScoHistoricoOcorrFornId() {
	}

	public ScoHistoricoOcorrFornId(Integer frnNumero, Short numero) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ScoHistoricoOcorrFornId)) {
			return false;
		}
		ScoHistoricoOcorrFornId other = (ScoHistoricoOcorrFornId) obj;
