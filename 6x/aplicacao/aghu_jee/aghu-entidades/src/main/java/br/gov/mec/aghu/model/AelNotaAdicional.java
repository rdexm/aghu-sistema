...
@Entity
@Table(name = "AEL_NOTAS_ADICIONAIS", schema = "AGH")
public class AelNotaAdicional extends BaseEntityId<AelNotaAdicionalId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8603393238648210998L;
	private AelNotaAdicionalId id;
	...
	public AelNotaAdicionalId getId() {
		return this.id;
	}

	public void setId(AelNotaAdicionalId id) {
		this.id = id;
	}
