 ...
 */
@Entity
@SequenceGenerator(name="mciDuracMedidaPreventJn", sequenceName="AGH.MCI_DMP_JN_SEQ", allocationSize = 1)
@Table(name = "MCI_DURAC_MEDIDA_PREVENT_JN", schema = "AGH")
public class MciDuracaoMedidaPreventivaJn extends BaseJournal{
	...
	public MciDuracaoMedidaPreventivaJn() {
	}


	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mciDuracMedidaPreventJn")
