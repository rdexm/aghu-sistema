...
/**
 * MpaCadExameDiagnosticoId generated by hbm2java
 */
@Embeddable
public class MpaCadExameDiagnosticoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5427969961827763134L;
	private Short citVpaPtaSeq;
	private Short citVpaSeqp;
	private Short citSeqp;
	private Short seqp;

	public MpaCadExameDiagnosticoId() {
	}

	public MpaCadExameDiagnosticoId(Short citVpaPtaSeq, Short citVpaSeqp, Short citSeqp, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MpaCadExameDiagnosticoId)) {
			return false;
		}
		MpaCadExameDiagnosticoId other = (MpaCadExameDiagnosticoId) obj;
