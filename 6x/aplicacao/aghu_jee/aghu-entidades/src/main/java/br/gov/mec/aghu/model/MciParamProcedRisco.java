...
/**
 * MciParamProcedRisco generated by hbm2java
 */
@Entity
@Table(name = "MCI_PARAM_PROCED_RISCOS", schema = "AGH")
public class MciParamProcedRisco extends BaseEntityId<MciParamProcedRiscoId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1149488062997898406L;
	private MciParamProcedRiscoId id;
	...
	public MciParamProcedRisco() {
	}

	public MciParamProcedRisco(MciParamProcedRiscoId id, RapServidores rapServidores, MciParamReportUsuario mciParamReportUsuario,
			MciProcedimentoRisco mciProcedimentoRisco, Date criadoEm) {
		this.id = id;
	...
	public MciParamProcedRiscoId getId() {
		return this.id;
	}

	public void setId(MciParamProcedRiscoId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MciParamProcedRisco)) {
			return false;
		}
		MciParamProcedRisco other = (MciParamProcedRisco) obj;
		if (getId() == null) {
			if (other.getId() != null) {
				return false;
			}
