...
/**
 * FsoRefCode generated by hbm2java
 */
@Entity
@Table(name = "FSO_REF_CODES", schema = "AGH")
public class FsoRefCode extends BaseEntityId<FsoRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6077421942164077477L;
	private FsoRefCodeId id;

	public FsoRefCode() {
	}

	public FsoRefCode(FsoRefCodeId id) {
		this.id = id;
	}
	...
	public FsoRefCodeId getId() {
		return this.id;
	}

	public void setId(FsoRefCodeId id) {
		this.id = id;
	}
