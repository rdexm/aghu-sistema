...
/**
 * CseUsuarioUbsId generated by hbm2java
 */
@Embeddable
public class CseUsuarioUbsId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -785014207428457545L;
	private String id;
	...
	public CseUsuarioUbsId() {
	}

	public CseUsuarioUbsId(Integer version) {
		this.version = version;
	}

	public CseUsuarioUbsId(String id, String criadoPor, Date criadoEm, String tpuCodigo, Integer serMatricula, Short serVinCodigo,
	...
	@Column(name = "TPU_CODIGO", length = 2)
	@Length(max = 2)
	...
	@Column(name = "SENHA_INICIAL", length = 30)
	@Length(max = 30)
	...
	@Column(name = "CRIA_USER_REDE", length = 1)
	@Length(max = 1)
	...
	@Column(name = "CONSISTE_REDE", length = 1)
	@Length(max = 1)
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CseUsuarioUbsId)) {
			return false;
		}
		CseUsuarioUbsId other = (CseUsuarioUbsId) obj;
