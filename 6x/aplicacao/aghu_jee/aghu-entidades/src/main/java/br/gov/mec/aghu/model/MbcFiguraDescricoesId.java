...
/**
 * MbcFiguraDescricoesId generated by hbm2java
 */
@Embeddable
public class MbcFiguraDescricoesId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4871984857496610413L;
	private Integer dcgCrgSeq;
	private Short dcgSeqp;
	private Integer seqp;

	public MbcFiguraDescricoesId() {
	}

	public MbcFiguraDescricoesId(Integer dcgCrgSeq, Short dcgSeqp, Integer seqp) {
	...
	public boolean equals(Object obj) {
		...
		MbcFiguraDescricoesId other = (MbcFiguraDescricoesId) obj;
		if (dcgCrgSeq == null) {
