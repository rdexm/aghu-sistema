...
/**
 * FcuEntrDadoCrecheJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_CRECHE_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoCrecheJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 1052815146771258320L;
	...
	public FcuEntrDadoCrecheJn() {
	}

	public FcuEntrDadoCrecheJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq) {
	...
	public FcuEntrDadoCrecheJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq, Date dtInicioValidade,
			Date dtFimValidade, Integer cctCodigo, Short qtCriancas, Date criadoEm, Integer serMatricula, Short serVinCodigo,
