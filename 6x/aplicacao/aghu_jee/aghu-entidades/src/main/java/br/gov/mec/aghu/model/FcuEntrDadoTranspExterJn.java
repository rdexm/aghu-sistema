...
/**
 * FcuEntrDadoTranspExterJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_TRANSP_EXTER_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoTranspExterJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 1317370550529911776L;
	...
	public FcuEntrDadoTranspExterJn() {
	}

	public FcuEntrDadoTranspExterJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuEntrDadoTranspExterJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtCompetencia,
			Integer cctCodigo, Double qtKm, Date criadoEm, Integer serMatricula, Short serVinCodigo, String indProcessoMensal) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
