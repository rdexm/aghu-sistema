 ...
 */
@Entity
@Table(name = "EPE_PRESCRICOES_ENFERMAGEM", schema = "hist", uniqueConstraints = @UniqueConstraint(columnNames = {
		"ATD_SEQ", "DTHR_INICIO" }))

public class EpePrescricaoEnfermagemHist extends BaseEntityId<EpePrescricaoEnfermagemHistId> implements java.io.Serializable {
	...
	private static final long serialVersionUID = 8248416258739699320L;
	private Integer version;
	private EpePrescricaoEnfermagemHistId id;
	...
	private Set<EceOrdemDeAdministracaoHist> ordensDeAdministracaoHist = new HashSet<EceOrdemDeAdministracaoHist>(
			0);
	...
	public EpePrescricaoEnfermagemHistId getId() {
		return this.id;
	}

	public void setId(EpePrescricaoEnfermagemHistId id) {
		this.id = id;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "prescricaoEnfermagemHist")
	public Set<EceOrdemDeAdministracaoHist> getOrdensDeAdministracaoHist() {
		return this.ordensDeAdministracaoHist;
	}

	public void setOrdensDeAdministracaoHist(
			Set<EceOrdemDeAdministracaoHist> ordensDeAdministracaoHist) {
		this.ordensDeAdministracaoHist = ordensDeAdministracaoHist;
	}
	...
	public boolean equals(Object obj) {
		...
		EpePrescricaoEnfermagemHist other = (EpePrescricaoEnfermagemHist) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
