...
/**
 * RapPppRespMonitBiologicaId generated by hbm2java
 */
@Embeddable
public class RapPppRespMonitBiologicaId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1661352121292219396L;
	private Date dtInicio;
	private Integer serMatricula;
	private Short serVinCodigo;

	public RapPppRespMonitBiologicaId() {
	}

	public RapPppRespMonitBiologicaId(Date dtInicio, Integer serMatricula, Short serVinCodigo) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapPppRespMonitBiologicaId)) {
			return false;
		}
		RapPppRespMonitBiologicaId other = (RapPppRespMonitBiologicaId) obj;
