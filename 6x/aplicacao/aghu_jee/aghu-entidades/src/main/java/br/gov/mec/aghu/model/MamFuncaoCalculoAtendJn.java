...
@Entity
@Table(name = "MAM_FUNCAO_CALCULO_ATEND_JN", schema = "AGH")
@Immutable
public class MamFuncaoCalculoAtendJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 1496813938984679513L;
	...
	public MamFuncaoCalculoAtendJn() {
	}

	public MamFuncaoCalculoAtendJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer fclSeq, Short seqp) {
