...
/**
 * AbsAnticorpoPacienteJn generated by hbm2java
 */
@Entity
@Table(name = "ABS_ANTICORPOS_PACIENTES_JN", schema = "AGH")
@Immutable
public class AbsAnticorpoPacienteJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -5341499283965415391L;
	...
	public AbsAnticorpoPacienteJn() {
	}

	public AbsAnticorpoPacienteJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer rspPacCodigo, Short antSeq,
			Date rspDthrRegistro) {
	...
	public AbsAnticorpoPacienteJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer rspPacCodigo, Short antSeq,
			Date rspDthrRegistro, Date criadoEm, Integer serMatricula, Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
...
/* ATUALIZADOR JOURNALS - Get / Set	@Id
	...
	/* ATUALIZADOR JOURNALS - Fields	SEQ_JN("seqJn"),
		...
		RSP_PAC_CODIGO("rspPacCodigo"),
		ANT_SEQ("antSeq"),
		RSP_DTHR_REGISTRO("rspDthrRegistro"),
		CRIADO_EM("criadoEm"),
