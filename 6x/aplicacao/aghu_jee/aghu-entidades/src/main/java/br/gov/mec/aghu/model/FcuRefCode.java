...
/**
 * FcuRefCode generated by hbm2java
 */
@Entity
@Table(name = "FCU_REF_CODES", schema = "AGH")
public class FcuRefCode extends BaseEntityId<FcuRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2580414309571745441L;
	private FcuRefCodeId id;

	public FcuRefCode() {
	}

	public FcuRefCode(FcuRefCodeId id) {
		this.id = id;
	}
	...
	public FcuRefCodeId getId() {
		return this.id;
	}

	public void setId(FcuRefCodeId id) {
		this.id = id;
	}
