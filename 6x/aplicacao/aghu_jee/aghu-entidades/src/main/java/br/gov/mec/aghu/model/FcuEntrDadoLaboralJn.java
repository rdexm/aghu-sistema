...
/**
 * FcuEntrDadoLaboralJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_LABORAL_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoLaboralJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -7182205998032200374L;
	...
	public FcuEntrDadoLaboralJn() {
	}

	public FcuEntrDadoLaboralJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuEntrDadoLaboralJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtCompetencia,
			Integer cctCodigo, Short qtFunc, Date criadoEm, Integer serMatricula, Short serVinCodigo, String indProcessoMensal) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
