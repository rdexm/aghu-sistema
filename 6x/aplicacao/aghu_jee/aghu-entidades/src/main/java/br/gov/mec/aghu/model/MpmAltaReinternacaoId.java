...
/**
 * MpmAltaReinternacoesId generated by hbm2java
 */

@Embeddable
public class MpmAltaReinternacaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5116713967901916150L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmAltaReinternacaoId() {
	}

	public MpmAltaReinternacaoId(Integer asuApaAtdSeq, Integer asuApaSeq, Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaReinternacaoId)) {
			return false;
		}
		MpmAltaReinternacaoId castOther = (MpmAltaReinternacaoId) other;
