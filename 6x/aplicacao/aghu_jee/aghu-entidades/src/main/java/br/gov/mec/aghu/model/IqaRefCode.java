...
@Entity
@Table(name = "IQA_REF_CODES", schema = "AGH")
public class IqaRefCode extends BaseEntityId<IqaRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1723152183008495411L;
	private IqaRefCodeId id;

	public IqaRefCode() {
	}

	public IqaRefCode(IqaRefCodeId id) {
		this.id = id;
	}
	...
	public IqaRefCodeId getId() {
		return this.id;
	}

	public void setId(IqaRefCodeId id) {
		this.id = id;
	}
