...
/**
 * FcuEntrDadoLuzJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_LUZ_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoLuzJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 4962057452553447950L;
	...
	public FcuEntrDadoLuzJn() {
	}

	public FcuEntrDadoLuzJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq) {
	...
	public FcuEntrDadoLuzJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq, Short gccSeq,
			Date dtInicioValidade, Date dtFimValidade, Double contribuicaoKwh, Date criadoEm, Integer serMatricula, Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
...
/* ATUALIZADOR JOURNALS - Get / Set	@Id
	...
	@Column(name = "CONTRIBUICAO_KWH", precision = 17, scale = 17)
