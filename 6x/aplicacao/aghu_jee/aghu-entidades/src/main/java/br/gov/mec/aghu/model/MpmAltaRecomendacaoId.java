...
/**
 * MpmAltaRecomendacoesId generated by hbm2java
 */

@Embeddable
public class MpmAltaRecomendacaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8232420180650505086L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;
	private Short seqp;

	public MpmAltaRecomendacaoId() {
	}

	public MpmAltaRecomendacaoId(Integer asuApaAtdSeq, Integer asuApaSeq,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaRecomendacaoId)) {
			return false;
		}
		MpmAltaRecomendacaoId castOther = (MpmAltaRecomendacaoId) other;
