...
/**
 * FcuIndConsumoPrevistoJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_IND_CONSUMO_PREVISTOS_JN", schema = "AGH")
@Immutable
public class FcuIndConsumoPrevistoJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 2266766899004609331L;
	...
	public FcuIndConsumoPrevistoJn() {
	}

	public FcuIndConsumoPrevistoJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuIndConsumoPrevistoJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtInicioValidade,
			Date dtFimValidade, Integer cctCodigo, Short gmtCodigo, Double indAjuste, Date criadoEm, Integer serMatricula,
			Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
