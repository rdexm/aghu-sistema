...
/**
 * AelProjetoComponente generated by hbm2java
 */
@Entity
@Table(name = "AEL_PROJETO_COMPONENTES", schema = "AGH")
public class AelProjetoComponente extends BaseEntityId<AelProjetoComponenteId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7388167614949809806L;
	private AelProjetoComponenteId id;
	...
	public AelProjetoComponente() {
	}

	public AelProjetoComponente(AelProjetoComponenteId id, RapServidores rapServidores, AelProjetoPesquisas aelProjetoPesquisas,
			AbsComponenteSanguineo absComponenteSanguineo, Date dtInicio, String indSituacao, Date criadoEm) {
		this.id = id;
	...
	public AelProjetoComponente(AelProjetoComponenteId id, RapServidores rapServidores, AelProjetoPesquisas aelProjetoPesquisas,
			AbsComponenteSanguineo absComponenteSanguineo, String numero, Date dtInicio, Date dtFim, Short qtdeSolicitado,
			Short qtdePermitido, Double valor, String indSituacao, Date criadoEm) {
		this.id = id;
		this.rapServidores = rapServidores;
		this.aelProjetoPesquisas = aelProjetoPesquisas;
		this.absComponenteSanguineo = absComponenteSanguineo;
	...
	public AelProjetoComponenteId getId() {
		return this.id;
	}

	public void setId(AelProjetoComponenteId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AelProjetoComponente)) {
			return false;
		}
		AelProjetoComponente other = (AelProjetoComponente) obj;
		if (getId() == null) {
			if (other.getId() != null) {
				return false;
			}
