...
/**
 * RapPppProfissiografiaId generated by hbm2java
 */
@Embeddable
public class RapPppProfissiografiaId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4565752910795305593L;
	private Date dtInicio;
	private Integer serMatricula;
	private Short serVinCodigo;

	public RapPppProfissiografiaId() {
	}

	public RapPppProfissiografiaId(Date dtInicio, Integer serMatricula, Short serVinCodigo) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapPppProfissiografiaId)) {
			return false;
		}
		RapPppProfissiografiaId other = (RapPppProfissiografiaId) obj;
