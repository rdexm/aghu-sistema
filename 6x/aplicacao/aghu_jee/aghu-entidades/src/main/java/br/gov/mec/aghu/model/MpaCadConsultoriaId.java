...
/**
 * MpaCadConsultoriaId generated by hbm2java
 */
@Embeddable
public class MpaCadConsultoriaId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8227936912141134188L;
	private Short citVpaPtaSeq;
	private Short citVpaSeqp;
	private Short citSeqp;
	private Short seqp;

	public MpaCadConsultoriaId() {
	}

	public MpaCadConsultoriaId(Short citVpaPtaSeq, Short citVpaSeqp, Short citSeqp, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MpaCadConsultoriaId)) {
			return false;
		}
		MpaCadConsultoriaId other = (MpaCadConsultoriaId) obj;
