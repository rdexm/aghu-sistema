...
/**
 * RapUniServPlanoId generated by hbm2java
 */
@Embeddable
public class RapUniServPlanoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1398186344669573779L;
	private Integer sadSerMatricula;
	private Short sadSerVinCodigo;
	private Short sadSeqp;
	private Date dtInicio;

	public RapUniServPlanoId() {
	}

	public RapUniServPlanoId(Integer sadSerMatricula, Short sadSerVinCodigo, Short sadSeqp, Date dtInicio) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniServPlanoId)) {
			return false;
		}
		RapUniServPlanoId other = (RapUniServPlanoId) obj;
