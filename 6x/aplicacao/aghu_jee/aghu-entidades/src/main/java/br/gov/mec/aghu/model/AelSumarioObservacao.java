...
@Entity
@Table(name = "AEL_SUMARIO_OBSERVACAO", schema = "AGH")
public class AelSumarioObservacao extends BaseEntityId<AelSumarioObservacaoId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1712771934699920446L;
	private AelSumarioObservacaoId id;

	public AelSumarioObservacao() {
	}

	public AelSumarioObservacao(AelSumarioObservacaoId id) {
		this.id = id;
	}
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "codigoMensagem", column = @Column(name = "CODIGO_MENSAGEM", nullable = false, precision = 17, scale = 17)),
	...
	public AelSumarioObservacaoId getId() {
		return this.id;
	}

	public void setId(AelSumarioObservacaoId id) {
		this.id = id;
	}
