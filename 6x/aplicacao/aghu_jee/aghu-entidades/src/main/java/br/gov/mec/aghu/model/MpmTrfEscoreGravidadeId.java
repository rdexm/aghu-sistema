...
/**
 * MpmTrfEscoreGravidadeId generated by hbm2java
 */
@Embeddable
public class MpmTrfEscoreGravidadeId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3851150388158029783L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmTrfEscoreGravidadeId() {
	}

	public MpmTrfEscoreGravidadeId(Integer asuApaAtdSeq, Integer asuApaSeq,
			Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmTrfEscoreGravidadeId)) {
			return false;
		}
		MpmTrfEscoreGravidadeId castOther = (MpmTrfEscoreGravidadeId) other;
