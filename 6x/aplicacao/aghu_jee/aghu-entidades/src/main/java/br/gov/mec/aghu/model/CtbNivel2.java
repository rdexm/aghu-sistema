...
/**
 * CtbNivel2 generated by hbm2java
 */
@Entity
@Table(name = "CTB_NIVEL_2", schema = "AGH")
public class CtbNivel2 extends BaseEntityId<CtbNivel2Id> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8043174162837157237L;
	private CtbNivel2Id id;
	...
	public CtbNivel2(CtbNivel2Id id, RapServidores rapServidores, String descricao, Date criadoEm, Short ideSeq) {
		this.id = id;
	...
	public CtbNivel2(CtbNivel2Id id, CtbNaturezaPlano ctbNaturezaPlano, CtbGrupoNaturezaPlano ctbGrupoNaturezaPlano,
			RapServidores rapServidores, String descricao, Date criadoEm, Date alteradoEm, Short ideSeq, Set<CtbNivel3> ctbNivel3s) {
		this.id = id;
	...
	@AttributeOverrides({ @AttributeOverride(name = "seqp", column = @Column(name = "SEQP", nullable = false)),
			@AttributeOverride(name = "nv1Seq", column = @Column(name = "NV1_SEQ", nullable = false)) })
	public CtbNivel2Id getId() {
		return this.id;
	}

	public void setId(CtbNivel2Id id) {
		this.id = id;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "ctbNivel2")
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CtbNivel2)) {
			return false;
		}
		CtbNivel2 other = (CtbNivel2) obj;
		if (getId() == null) {
			if (other.getId() != null) {
				return false;
			}
