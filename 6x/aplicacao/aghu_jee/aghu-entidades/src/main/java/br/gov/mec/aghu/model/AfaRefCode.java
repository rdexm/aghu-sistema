...
/**
 * AfaRefCode generated by hbm2java
 */
@Entity
@Table(name = "AFA_REF_CODES", schema = "AGH")
public class AfaRefCode extends BaseEntityId<AfaRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8096365675242691011L;
	private AfaRefCodeId id;

	public AfaRefCode() {
	}

	public AfaRefCode(AfaRefCodeId id) {
		this.id = id;
	}
	...
	public AfaRefCodeId getId() {
		return this.id;
	}

	public void setId(AfaRefCodeId id) {
		this.id = id;
	}
