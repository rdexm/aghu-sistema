...
/**
 * MpmTrfMotivoId generated by hbm2java
 */
@Embeddable
public class MpmTrfMotivoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2012858155096114262L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmTrfMotivoId() {
	}

	public MpmTrfMotivoId(Integer asuApaAtdSeq, Integer asuApaSeq, Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmTrfMotivoId)) {
			return false;
		}
		MpmTrfMotivoId castOther = (MpmTrfMotivoId) other;
