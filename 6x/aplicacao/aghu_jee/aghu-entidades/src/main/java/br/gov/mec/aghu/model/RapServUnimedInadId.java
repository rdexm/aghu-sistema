...
/**
 * RapServUnimedInadId generated by hbm2java
 */
@Embeddable
public class RapServUnimedInadId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -840566174986737594L;
	private Integer serMatricula;
	private Short serVinCodigo;
	private Date dtInicio;

	public RapServUnimedInadId() {
	}

	public RapServUnimedInadId(Integer serMatricula, Short serVinCodigo, Date dtInicio) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapServUnimedInadId)) {
			return false;
		}
		RapServUnimedInadId other = (RapServUnimedInadId) obj;
