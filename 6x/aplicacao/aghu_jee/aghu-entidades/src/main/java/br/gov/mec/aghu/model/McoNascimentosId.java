...
/**
 * McoNascimentosId generated by hbm2java
 */
@Embeddable
public class McoNascimentosId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6131130434403796694L;
	private Integer gsoPacCodigo;
	private Short gsoSeqp;
	private Integer seqp;

	public McoNascimentosId() {
	}

	public McoNascimentosId(Integer gsoPacCodigo, Short gsoSeqp, Integer seqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof McoNascimentosId)) {
			return false;
		}
		McoNascimentosId castOther = (McoNascimentosId) other;
