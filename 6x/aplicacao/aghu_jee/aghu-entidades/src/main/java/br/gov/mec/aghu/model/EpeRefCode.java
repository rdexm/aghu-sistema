...
/**
 * EpeRefCode generated by hbm2java
 */
@Entity
@Table(name = "EPE_REF_CODES", schema = "AGH")
public class EpeRefCode extends BaseEntityId<EpeRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8821913369964588950L;
	private EpeRefCodeId id;

	public EpeRefCode() {
	}

	public EpeRefCode(EpeRefCodeId id) {
		this.id = id;
	}
	...
	public EpeRefCodeId getId() {
		return this.id;
	}

	public void setId(EpeRefCodeId id) {
		this.id = id;
	}
