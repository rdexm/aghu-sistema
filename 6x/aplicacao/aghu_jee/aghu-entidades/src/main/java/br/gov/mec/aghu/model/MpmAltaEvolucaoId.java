...
/**
 * MpmAltaEvolucoesId generated by hbm2java
 */

@Embeddable
public class MpmAltaEvolucaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2383900178910387595L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmAltaEvolucaoId() {
	}

	public MpmAltaEvolucaoId(Integer asuApaAtdSeq, Integer asuApaSeq, Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaEvolucaoId)) {
			return false;
		}
		MpmAltaEvolucaoId castOther = (MpmAltaEvolucaoId) other;
