 ...
 */
@Embeddable
public class AelAmostraItemExamesId implements EntityCompositeId {
	...
	public AelAmostraItemExamesId() {
	}

	public AelAmostraItemExamesId(Integer iseSoeSeq, Short iseSeqp, Integer amoSoeSeq,
			Integer amoSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AelAmostraItemExamesId)) {
			return false;
		}
		AelAmostraItemExamesId castOther = (AelAmostraItemExamesId) other;

		return (this.getIseSoeSeq().equals(castOther.getIseSoeSeq())
				&& (this.getIseSeqp().equals(castOther.getIseSeqp()))
				&& (this.getAmoSoeSeq().equals(castOther.getAmoSoeSeq()))
				&& (this.getAmoSeqp().equals(castOther.getAmoSeqp())));
	}
