...
/**
 * MpaUsuarioHomologacaoId generated by hbm2java
 */
@Embeddable
public class MpaUsuarioHomologacaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7103153660900875138L;
	private Short vpaPtaSeq;
	private Short vpaSeqp;
	private Short seqp;

	public MpaUsuarioHomologacaoId() {
	}

	public MpaUsuarioHomologacaoId(Short vpaPtaSeq, Short vpaSeqp, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MpaUsuarioHomologacaoId)) {
			return false;
		}
		MpaUsuarioHomologacaoId other = (MpaUsuarioHomologacaoId) obj;
