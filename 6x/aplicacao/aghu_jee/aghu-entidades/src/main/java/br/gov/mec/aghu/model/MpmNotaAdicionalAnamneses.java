...
@Entity
@SequenceGenerator(name = "mpmNaaSeq", sequenceName = "AGH.mpm_naa_sq1", allocationSize = 1)
@Table(name = "MPM_NOTA_ADICIONAL_ANAMNESES", schema = "AGH")
public class MpmNotaAdicionalAnamneses extends BaseEntitySeq<Integer> implements java.io.Serializable {
	...
	private MpmAnamneses mpmAnamneses;
	private RapServidores servidor;
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mpmNaaSeq")
	...
	public MpmAnamneses getMpmAnamneses() {
		return mpmAnamneses;
	}

	public void setMpmAnamneses(MpmAnamneses mpmAnamneses) {
		this.mpmAnamneses = mpmAnamneses;
	}
	...
	public enum Fields {
		...
		PENDENTE("pendente"),
		SEQ("seq"),
		ANAMNESES_SEQ("mpmAnamneses.seq"),
		ANAMNESE("mpmAnamneses");
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MpmNotaAdicionalAnamneses)) {
			return false;
		}
		MpmNotaAdicionalAnamneses other = (MpmNotaAdicionalAnamneses) obj;
		if (getSeq() == null) {
