...
/**
 * RapConsultorCcustoId generated by hbm2java
 */
@Embeddable
public class RapConsultorCcustoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -789113371280823782L;
	private Integer serMatricula;
	private Short serVinCodigo;
	private Short seqp;

	public RapConsultorCcustoId() {
	}

	public RapConsultorCcustoId(Integer serMatricula, Short serVinCodigo, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapConsultorCcustoId)) {
			return false;
		}
		RapConsultorCcustoId other = (RapConsultorCcustoId) obj;
