...
/**
 * ScoClassifMatNiv4Jn generated by hbm2java
 */
@Entity
@Table(name = "SCO_CLASSIF_MAT_NIV4_JN", schema = "AGH")
@SequenceGenerator(name = "scoCn4JnSeq", sequenceName = "AGH.SCO_CN4_JN_SEQ")
@Immutable
public class ScoClassifMatNiv4Jn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -6025385539114956042L;
	...
	public ScoClassifMatNiv4Jn() {
	}

	public ScoClassifMatNiv4Jn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer cn3Cn2Cn1GmtCodigo,
			Integer cn3Cn2Cn1Codigo, Integer cn3Cn2Codigo, Integer cn3Codigo, Integer codigo) {
	...
	public ScoClassifMatNiv4Jn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer cn3Cn2Cn1GmtCodigo,
			Integer cn3Cn2Cn1Codigo, Integer cn3Cn2Codigo, Integer cn3Codigo, Integer codigo, String descricao, Integer serMatricula,
			Short serVinCodigo, Date criadoEm, Integer serMatriculaAlterado, Short serVinCodigoAlterado) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "scoCn4JnSeq")
	@Override	
...
/* ATUALIZADOR JOURNALS - Get / Set	@Id
	...
	@Column(name = "CN3_CN2_CN1_GMT_CODIGO", nullable = false)
	...
	@Column(name = "CN3_CN2_CN1_CODIGO", nullable = false)
	...
	@Column(name = "CN3_CN2_CODIGO", nullable = false)
	...
	@Column(name = "CN3_CODIGO", nullable = false)
	...
	/* ATUALIZADOR JOURNALS - Fields	SEQ_JN("seqJn"),
		...
		CN3_CN2_CN1_GMT_CODIGO("cn3Cn2Cn1GmtCodigo"),
		CN3_CN2_CN1_CODIGO("cn3Cn2Cn1Codigo"),
		CN3_CN2_CODIGO("cn3Cn2Codigo"),
