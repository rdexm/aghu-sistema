...
@Entity
@Table(name = "MAM_RESPOSTA_X_TOPOGRAFIAS_JN", schema = "AGH")
@Immutable
public class MamRespostaXTopografiaJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -3067400792247871252L;
	...
	public MamRespostaXTopografiaJn() {
	}

	public MamRespostaXTopografiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public MamRespostaXTopografiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, String contaminacao,
			String infeccao, String endometrite, String feridaOperatoria, String indTipoPista, Short topSeq, String indSituacao,
