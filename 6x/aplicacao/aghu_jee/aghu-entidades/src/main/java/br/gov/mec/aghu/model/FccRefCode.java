...
/**
 * FccRefCode generated by hbm2java
 */
@Entity
@Table(name = "FCC_REF_CODES", schema = "AGH")
public class FccRefCode extends BaseEntityId<FccRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8450433711411326476L;
	private FccRefCodeId id;

	public FccRefCode() {
	}

	public FccRefCode(FccRefCodeId id) {
		this.id = id;
	}
	...
	public FccRefCodeId getId() {
		return this.id;
	}

	public void setId(FccRefCodeId id) {
		this.id = id;
	}
