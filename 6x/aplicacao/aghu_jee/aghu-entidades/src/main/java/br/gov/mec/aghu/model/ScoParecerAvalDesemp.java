...
/**
 * ScoParecer Avaliacao Desempenho generated by hbm2java
 */
@Entity
@Table(name = "SCO_PARECER_AVAL_DESEMP", schema = "AGH")
@SequenceGenerator(name="scoPadSq1", sequenceName="AGH.SCO_PAD_SQ1", allocationSize = 1)
public class ScoParecerAvalDesemp extends BaseEntityCodigo<Integer> implements java.io.Serializable {	
	...
	public ScoParecerAvalDesemp(){
	}

	@Id
	@Column(name = "CODIGO", nullable = false, precision = 6, scale = 0)
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "scoPadSq1")
	...
	public boolean equals(Object other) {
		if (other instanceof ScoParecerAvalDesemp){
			ScoParecerAvalDesemp castOther = (ScoParecerAvalDesemp) other;
