...
@Entity
@Table(name = "ABS_TIPOS_CARTAS_JN", schema = "AGH")
@Immutable
public class AbsTipoCartaJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -374554631377418493L;
	...
	public AbsTipoCartaJn() {
	}

	public AbsTipoCartaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, String codigo) {
	...
	public AbsTipoCartaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, String codigo, String descricao,
			String indHistorico, String grupoCarta, String nomeReport, Date criadoEm, Integer serMatricula, Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
...
/* ATUALIZADOR JOURNALS - Get / Set	@Id
	...
	@Column(name = "GRUPO_CARTA", length = 2)
	@Length(max = 2)
