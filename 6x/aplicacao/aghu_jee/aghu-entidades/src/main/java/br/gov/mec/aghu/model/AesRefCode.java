...
/**
 * AesRefCode generated by hbm2java
 */
@Entity
@Table(name = "AES_REF_CODES", schema = "AGH")
public class AesRefCode extends BaseEntityId<AesRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8863294048629877794L;
	private AesRefCodeId id;

	public AesRefCode() {
	}

	public AesRefCode(AesRefCodeId id) {
		this.id = id;
	}
	...
	public AesRefCodeId getId() {
		return this.id;
	}

	public void setId(AesRefCodeId id) {
		this.id = id;
	}
