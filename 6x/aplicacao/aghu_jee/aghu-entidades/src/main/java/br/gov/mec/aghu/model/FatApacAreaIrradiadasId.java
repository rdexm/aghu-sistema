...
/**
 * FatApacAreaIrradiadasId generated by hbm2java
 */
@Embeddable
public class FatApacAreaIrradiadasId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2408594864588527159L;
	private Long capAtmNumero;
	private Byte capSeqp;
	private boolean seqp;

	public FatApacAreaIrradiadasId() {
	}

	public FatApacAreaIrradiadasId(Long capAtmNumero, Byte capSeqp, boolean seqp) {
	...
	@Column(name = "SEQP", nullable = false, precision = 1, scale = 0)
	public boolean isSeqp() {
		return this.seqp;
	}

	public void setSeqp(boolean seqp) {
		this.seqp = seqp;
	}
	...
	public int hashCode() {
		...
		result = prime * result + (seqp ? 1231 : 1237);
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FatApacAreaIrradiadasId)) {
			return false;
		}
		FatApacAreaIrradiadasId other = (FatApacAreaIrradiadasId) obj;
