...
/**
 * MpmTrfDiagnosticoId generated by hbm2java
 */

@Embeddable
public class MpmTrfDiagnosticoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1385877285104460934L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;
	private Short seqp;

	public MpmTrfDiagnosticoId() {
	}

	public MpmTrfDiagnosticoId(Integer asuApaAtdSeq, Integer asuApaSeq, Short asuSeqp,
			Short seqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmTrfDiagnosticoId)) {
			return false;
		}
		MpmTrfDiagnosticoId castOther = (MpmTrfDiagnosticoId) other;
