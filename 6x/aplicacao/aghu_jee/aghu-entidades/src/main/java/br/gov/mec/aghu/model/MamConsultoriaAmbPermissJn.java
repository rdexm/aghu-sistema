...
/**
 * MamConsultoriaAmbPermissJn generated by hbm2java
 */
@Entity
@Table(name = "MAM_CONSULTORIA_AMB_PERMISS_JN", schema = "AGH")
@Immutable
public class MamConsultoriaAmbPermissJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -5278202118623283544L;
	...
	public MamConsultoriaAmbPermissJn() {
	}

	public MamConsultoriaAmbPermissJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public MamConsultoriaAmbPermissJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Short espSeq,
			Date dtInicio, Date dtFim, Date criadoEm, Integer serMatricula, Short serVinCodigo, Date alteradoEm,
