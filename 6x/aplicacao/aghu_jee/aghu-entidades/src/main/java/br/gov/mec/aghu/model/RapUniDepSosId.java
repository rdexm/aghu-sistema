...
/**
 * RapUniDepSosId generated by hbm2java
 */
@Embeddable
public class RapUniDepSosId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8366244695399802255L;
	...
	public RapUniDepSosId() {
	}

	public RapUniDepSosId(Integer sdeSadSerMatricula, Short sdeSadSerVinCodigo, Short sdeSadSeqp, Integer sdeDepPesCodigo, Integer sdeDepCodigo,
			Date sdeDtInicio) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniDepSosId)) {
			return false;
		}
		RapUniDepSosId other = (RapUniDepSosId) obj;
