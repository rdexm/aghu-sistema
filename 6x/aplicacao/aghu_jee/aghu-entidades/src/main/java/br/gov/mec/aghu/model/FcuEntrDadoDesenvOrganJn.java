...
/**
 * FcuEntrDadoDesenvOrganJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_DESENV_ORGAN_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoDesenvOrganJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -5644879327505589583L;
	...
	public FcuEntrDadoDesenvOrganJn() {
	}

	public FcuEntrDadoDesenvOrganJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuEntrDadoDesenvOrganJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtCompetencia,
			Integer cctCodigo, Double qtHoras, Date criadoEm, Integer serMatricula, Short serVinCodigo, String indProcessoMensal) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
