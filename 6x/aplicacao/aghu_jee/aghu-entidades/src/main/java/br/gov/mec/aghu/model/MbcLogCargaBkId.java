...
/**
 * MbcLogCargaBkId generated by hbm2java
 */
@Embeddable
public class MbcLogCargaBkId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3917860846424818227L;
	...
	public MbcLogCargaBkId() {
	}

	public MbcLogCargaBkId(Integer version) {
		this.version = version;
	}

	public MbcLogCargaBkId(String tabela, String erro, Date criadoEm, String msg, Integer version) {
		this.tabela = tabela;
		this.erro = erro;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MbcLogCargaBkId)) {
			return false;
		}
		MbcLogCargaBkId other = (MbcLogCargaBkId) obj;
