...
@Entity
@SequenceGenerator(name = "aelLubJnSeq", sequenceName = "AGH.AEL_LUB_JN_SEQ", allocationSize = 1)
@Table(name = "AEL_GRP_TXT_PADRAO_MACROS_JN", schema = "AGH")
@Immutable
public class AelGrpTxtPadraoMacroJn extends BaseJournal {
	...
	public AelGrpTxtPadraoMacroJn() {
	}

	public AelGrpTxtPadraoMacroJn(final Short seq, final String descricao, final DominioSituacao indSituacao,
	...
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "aelLubJnSeq")
	...
	public boolean equals(Object obj) {
		...
		AelGrpTxtPadraoMacroJn other = (AelGrpTxtPadraoMacroJn) obj;
		if (getSeqJn() == null) {
