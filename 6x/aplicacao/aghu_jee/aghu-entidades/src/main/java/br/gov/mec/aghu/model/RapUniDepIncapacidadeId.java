...
/**
 * RapUniDepIncapacidadeId generated by hbm2java
 */
@Embeddable
public class RapUniDepIncapacidadeId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1740491129657166033L;
	...
	private Short minSeq;

	public RapUniDepIncapacidadeId() {
	}

	public RapUniDepIncapacidadeId(Integer sdeSadSerMatricula, Short sdeSadSerVinCodigo, Short sdeSadSeqp, Integer sdeDepPesCodigo,
			Integer sdeDepCodigo, Date sdeDtInicio, Date dtInicio, Short minSeq) {
	...
	@Column(name = "MIN_SEQ", nullable = false)
	public Short getMinSeq() {
		return this.minSeq;
	}

	public void setMinSeq(Short minSeq) {
		this.minSeq = minSeq;
	}
	...
	public int hashCode() {
		...
		umHashCodeBuilder.append(this.getMinSeq());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniDepIncapacidadeId)) {
			return false;
		}
		RapUniDepIncapacidadeId other = (RapUniDepIncapacidadeId) obj;
		...
		umEqualsBuilder.append(this.getMinSeq(), other.getMinSeq());
