...
/**
 * MamUnidXSinalVitalJn generated by hbm2java
 */
@Entity
@Table(name = "MAM_UNID_X_SINAL_VITAIS_JN", schema = "AGH")
@Immutable
public class MamUnidXSinalVitalJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 7333430091932141868L;
	...
	public MamUnidXSinalVitalJn() {
	}

	public MamUnidXSinalVitalJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer sviSeq, Short uanUnfSeq) {
