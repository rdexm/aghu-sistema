...
/**
 * ScoParecer Avaliacao Consul generated by hbm2java
 */
@Entity
@Table(name = "SCO_PARECER_AVAL_CONSUL", schema = "AGH")
@SequenceGenerator(name="scoPanSq1", sequenceName="AGH.SCO_PAN_SQ1", allocationSize = 1)
public class ScoParecerAvalConsul extends BaseEntityCodigo<Integer> implements java.io.Serializable {		
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7720316615467486309L;
	...
	public ScoParecerAvalConsul(){
	}

	@Id
	@Column(name = "CODIGO", nullable = false, precision = 6, scale = 0)
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "scoPanSq1")
	...
	public boolean equals(Object other) {
		if (other instanceof ScoParecerAvalConsul){
			ScoParecerAvalConsul castOther = (ScoParecerAvalConsul) other;
