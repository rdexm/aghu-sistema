...
/**
 * AelProjetoComponenteJn generated by hbm2java
 */
@Entity
@Table(name = "AEL_PROJETO_COMPONENTES_JN", schema = "AGH")
@Immutable
public class AelProjetoComponenteJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -2897141024357006301L;
	...
	public AelProjetoComponenteJn() {
	}

	public AelProjetoComponenteJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer pjqSeq, String csaCodigo) {
	...
	public AelProjetoComponenteJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short qtdePermitido, Date criadoEm,
			Date dtInicio, Date dtFim, String indSituacao, Double valor, String numero, Short qtdeSolicitado, Integer pjqSeq,
			Integer serMatricula, Short serVinCodigo, String csaCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
