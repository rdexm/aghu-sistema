...
/**
 * RapRefCode generated by hbm2java
 */
@Entity
@Table(name = "RAP_REF_CODES", schema = "AGH")
public class RapRefCode extends BaseEntityId<RapRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7644780052290147909L;
	private RapRefCodeId id;

	public RapRefCode() {
	}

	public RapRefCode(RapRefCodeId id) {
		this.id = id;
	}
	...
	public RapRefCodeId getId() {
		return this.id;
	}

	public void setId(RapRefCodeId id) {
		this.id = id;
	}
