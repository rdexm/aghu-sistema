...
/**
 * RapUniDepDocumentoId generated by hbm2java
 */
@Embeddable
public class RapUniDepDocumentoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5870006980701821134L;
	...
	private Short tdoSeq;

	public RapUniDepDocumentoId() {
	}

	public RapUniDepDocumentoId(Integer sdeSadSerMatricula, Short sdeSadSerVinCodigo, Short sdeSadSeqp, Integer sdeDepPesCodigo,
			Integer sdeDepCodigo, Date sdeDtInicio, Date dtInicio, Short tdoSeq) {
	...
	@Column(name = "TDO_SEQ", nullable = false)
	public Short getTdoSeq() {
		return this.tdoSeq;
	}

	public void setTdoSeq(Short tdoSeq) {
		this.tdoSeq = tdoSeq;
	}
	...
	public int hashCode() {
		...
		umHashCodeBuilder.append(this.getTdoSeq());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniDepDocumentoId)) {
			return false;
		}
		RapUniDepDocumentoId other = (RapUniDepDocumentoId) obj;
		...
		umEqualsBuilder.append(this.getTdoSeq(), other.getTdoSeq());
