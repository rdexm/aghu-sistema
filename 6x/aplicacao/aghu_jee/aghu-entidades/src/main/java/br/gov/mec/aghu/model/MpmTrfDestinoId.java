...
/**
 * MpmTrfDestinoId generated by hbm2java
 */
@Embeddable
public class MpmTrfDestinoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6087718661702112026L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmTrfDestinoId() {
	}

	public MpmTrfDestinoId(Integer asuApaAtdSeq, Integer asuApaSeq, Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmTrfDestinoId)) {
			return false;
		}
		MpmTrfDestinoId castOther = (MpmTrfDestinoId) other;
