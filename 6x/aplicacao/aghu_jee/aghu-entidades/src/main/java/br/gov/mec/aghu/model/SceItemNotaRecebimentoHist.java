 ...
 */
@Entity
@Table(name="SCE_ITEM_NRS", schema="HIST")
public class SceItemNotaRecebimentoHist extends BaseEntityId<SceItemNotaRecebimentoIdHist> implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2693058700441132420L;
	private SceItemNotaRecebimentoIdHist id;
	...
	public SceItemNotaRecebimentoHist() {
	}
...
//	public SceItemNotaRecebimentoIdHist getIdHist() {
//		return this.id;
//	}
//
//	public void setIdHist(SceItemNotaRecebimentoIdHist id) {
//		this.id = id;
//	}
	...
	public SceItemNotaRecebimentoIdHist getId() {
		return this.id;
	}

	@Override
	public void setId(SceItemNotaRecebimentoIdHist id) {
		this.id = id;
	}
	...
	@Column(name="IND_DEBITO_NR_IAF", length = 1)
...
//	}
	...
	public boolean equals(Object obj) {
		...
		SceItemNotaRecebimentoHist other = (SceItemNotaRecebimentoHist) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
