 ...
 */
@Embeddable
public class SceItemNotaRecebimentoId implements EntityCompositeId {
    ...
    public SceItemNotaRecebimentoId() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SceItemNotaRecebimentoId)) {
			return false;
		}
		SceItemNotaRecebimentoId castOther = (SceItemNotaRecebimentoId)other;
