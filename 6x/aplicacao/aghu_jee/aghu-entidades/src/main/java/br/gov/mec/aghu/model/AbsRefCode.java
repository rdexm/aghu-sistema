...
/**
 * AbsRefCode generated by hbm2java
 */
@Entity
@Table(name = "ABS_REF_CODES", schema = "AGH")
public class AbsRefCode extends BaseEntityId<AbsRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5955353778527136211L;
	private AbsRefCodeId id;

	public AbsRefCode() {
	}

	public AbsRefCode(AbsRefCodeId id) {
		this.id = id;
	}
	...
	public AbsRefCodeId getId() {
		return this.id;
	}

	public void setId(AbsRefCodeId id) {
		this.id = id;
	}
