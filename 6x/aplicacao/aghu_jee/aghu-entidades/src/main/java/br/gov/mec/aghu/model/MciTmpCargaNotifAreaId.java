...
/**
 * MciTmpCargaNotifAreaId generated by hbm2java
 */
@Embeddable
public class MciTmpCargaNotifAreaId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7730453630370626335L;
	private Date data;
	...
	public MciTmpCargaNotifAreaId() {
	}

	public MciTmpCargaNotifAreaId(Date data, Integer prontuario, Short porSeq, Date dtInicioNotif, Short qtDiasNotifTot, Integer intSeq,
			Integer version) {
		this.data = data;
	...
	public MciTmpCargaNotifAreaId(Date data, Integer prontuario, Short porSeq, Date dtInicioNotif, Date dtFimNotif, Short qtDiasNotifTot,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MciTmpCargaNotifAreaId)) {
			return false;
		}
		MciTmpCargaNotifAreaId other = (MciTmpCargaNotifAreaId) obj;
