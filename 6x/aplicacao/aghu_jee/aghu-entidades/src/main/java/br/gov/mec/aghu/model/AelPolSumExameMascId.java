...
/**
 * AelPolSumExameMascId generated by hbm2java
 */
@Embeddable
public class AelPolSumExameMascId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 617421939058505124L;
	...
	public AelPolSumExameMascId() {
	}

	public AelPolSumExameMascId(String ufeEmaExaSigla, Integer ufeEmaManSeq, Short ufeUnfSeq, DominioSumarioExame pertenceSumario, Integer iseSoeSeq,
			Short iseSeqp, Date dthrEventoLib, Integer ordemRelatorio, Integer ordemAgrupamento, Integer nroSessao, Integer version) {
	...
	public AelPolSumExameMascId(Integer prontuario, String ltoLtoId, Boolean recemNascido, String ufeEmaExaSigla, Integer ufeEmaManSeq,
			...
			Short serVinCodigoConsultado, Integer serMatriculaConsultado, Date dthrFim, Integer nroSessao, Integer version) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AelPolSumExameMascId)) {
			return false;
		}
		AelPolSumExameMascId other = (AelPolSumExameMascId) obj;
