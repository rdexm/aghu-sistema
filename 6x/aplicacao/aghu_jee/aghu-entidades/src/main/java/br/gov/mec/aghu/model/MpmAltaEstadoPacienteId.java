...
/**
 * MpmAltaEstadoPacientesId generated by hbm2java
 */
@Embeddable

public class MpmAltaEstadoPacienteId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7880006199450282168L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;

	public MpmAltaEstadoPacienteId() {
	}

	public MpmAltaEstadoPacienteId(Integer asuApaAtdSeq, Integer asuApaSeq,
			Short asuSeqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaEstadoPacienteId)) {
			return false;
		}
		MpmAltaEstadoPacienteId castOther = (MpmAltaEstadoPacienteId) other;
