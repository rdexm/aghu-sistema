...
public class CaracteristicaInternacaoUserType implements EnhancedUserType, ParameterizedType {
	private static final Log LOG = LogFactory.getLog(CaracteristicaInternacaoUserType.class);
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session)
		...
		if (value == null) {
			...
			st.setString(index, "Cand Apac Otorrino");
		}
	}
