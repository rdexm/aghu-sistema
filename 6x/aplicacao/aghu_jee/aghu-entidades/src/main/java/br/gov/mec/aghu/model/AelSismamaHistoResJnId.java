...
/**
 * AelSismamaHistoResJnId generated by hbm2java
 */
@Embeddable
public class AelSismamaHistoResJnId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6583728057635046335L;
	...
	public AelSismamaHistoResJnId() {
	}

	public AelSismamaHistoResJnId(String jnUser, Date jnDateTime,
	...
	public AelSismamaHistoResJnId(String jnUser, Date jnDateTime,
			String jnOperation, Integer seq, String s01Codigo, String resposta,
	...
	public int hashCode() {
		...
		umHashCodeBuilder.append(this.getS01Codigo());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AelSismamaHistoResJnId)) {
			return false;
		}
		AelSismamaHistoResJnId other = (AelSismamaHistoResJnId) obj;
		...
		umEqualsBuilder.append(this.getS01Codigo(), other.getS01Codigo());
