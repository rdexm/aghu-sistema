...
/**
 * ScoCodeControlId generated by hbm2java
 */
@Embeddable
public class ScoCodeControlId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5661495292583614257L;
	private String ccDomain;
	private String ccComment;
	private Long ccNextValue;
	private Integer version;

	public ScoCodeControlId() {
	}

	public ScoCodeControlId(String ccDomain, Long ccNextValue, Integer version) {
		this.ccDomain = ccDomain;
		this.ccNextValue = ccNextValue;
		this.version = version;
	}

	public ScoCodeControlId(String ccDomain, String ccComment, Long ccNextValue, Integer version) {
		this.ccDomain = ccDomain;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ScoCodeControlId)) {
			return false;
		}
		ScoCodeControlId other = (ScoCodeControlId) obj;
