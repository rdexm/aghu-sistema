...
/**
 * AinRefCode generated by hbm2java
 */
@Entity
@Table(name = "AIN_REF_CODES", schema = "AGH")
public class AinRefCode extends BaseEntityId<AinRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8790068543007607596L;
	private AinRefCodeId id;

	public AinRefCode() {
	}

	public AinRefCode(AinRefCodeId id) {
		this.id = id;
	}
	...
	public AinRefCodeId getId() {
		return this.id;
	}

	public void setId(AinRefCodeId id) {
		this.id = id;
	}
