...
/**
 * ScoContatoFornecedorId generated by hbm2java
 */
@Embeddable
public class ScoContatoFornecedorId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5631057580288778687L;
	private Integer frnNumero;
	private Short numero;

	public ScoContatoFornecedorId() {
	}

	public ScoContatoFornecedorId(Integer frnNumero, Short numero) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ScoContatoFornecedorId)) {
			return false;
		}
		ScoContatoFornecedorId other = (ScoContatoFornecedorId) obj;
