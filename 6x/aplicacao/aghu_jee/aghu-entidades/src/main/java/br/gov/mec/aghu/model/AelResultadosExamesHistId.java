...
@Embeddable
public class AelResultadosExamesHistId implements java.io.Serializable {
	...
	public AelResultadosExamesHistId() {
	}

	public AelResultadosExamesHistId(Integer iseSoeSeq, Short iseSeqp,
			String pclVelEmaExaSigla, Integer pclVelEmaManSeq,
			Integer pclVelSeqp, Integer pclCalSeq, Integer pclSeqp, Integer seqp) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AelResultadosExamesHistId)) {
			return false;
		}
		AelResultadosExamesHistId other = (AelResultadosExamesHistId) obj;
