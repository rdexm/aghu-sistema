...
/**
 * RapCurPublicacaoId generated by hbm2java
 */
@Embeddable
public class RapCurPublicacaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6268331687176619883L;
	private Integer pesCodigo;
	private Short seqp;

	public RapCurPublicacaoId() {
	}

	public RapCurPublicacaoId(Integer pesCodigo, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapCurPublicacaoId)) {
			return false;
		}
		RapCurPublicacaoId other = (RapCurPublicacaoId) obj;
