...
/**
 * AelSumambExameTab generated by hbm2java
 */
@Entity
@Table(name = "AEL_SUMAMB_EXAMES_TAB", schema = "AGH")
public class AelSumambExameTab extends BaseEntityId<AelSumambExameTabId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4018694506965814944L;
	private AelSumambExameTabId id;

	public AelSumambExameTab() {
	}

	public AelSumambExameTab(AelSumambExameTabId id) {
		this.id = id;
	}
	...
	public AelSumambExameTabId getId() {
		return this.id;
	}

	public void setId(AelSumambExameTabId id) {
		this.id = id;
	}
