...
@Entity
@Table(name = "V_AEL_PESQ_POL_EXAMES_UNID", schema = "AGH")
@Immutable
public class VAelPesquisaPolExameUnidade extends BaseEntityId<VAelPesquisaPolExameUnidadeId> implements java.io.Serializable {
	...
	public VAelPesquisaPolExameUnidade() {
	}
	
	public VAelPesquisaPolExameUnidade(VAelPesquisaPolExameUnidadeId id, String unfDescricao, Short unfSeq,
	...
	public boolean equals(Object obj) {
		...
		VAelPesquisaPolExameUnidade other = (VAelPesquisaPolExameUnidade) obj;
		if (id == null) {
			if (other.id != null){
				return false;
			}
