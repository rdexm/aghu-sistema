...
/**
 * CtbRefCode generated by hbm2java
 */
@Entity
@Table(name = "CTB_REF_CODES", schema = "AGH")
public class CtbRefCode extends BaseEntityId<CtbRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 206786116525282173L;
	private CtbRefCodeId id;

	public CtbRefCode() {
	}

	public CtbRefCode(CtbRefCodeId id) {
		this.id = id;
	}
	...
	public CtbRefCodeId getId() {
		return this.id;
	}

	public void setId(CtbRefCodeId id) {
		this.id = id;
	}
