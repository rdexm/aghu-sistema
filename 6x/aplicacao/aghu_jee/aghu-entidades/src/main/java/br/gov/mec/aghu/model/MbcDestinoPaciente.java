...
/**
 * MbcDestinoPacientes generated by hbm2java
 */
@Entity
//@SequenceGenerator(name="mbcDpaSq1", sequenceName="AGH.MBC_DPA_SQ1", allocationSize = 1)
@Table(name = "MBC_DESTINO_PACIENTES", schema = "AGH")

public class MbcDestinoPaciente extends BaseEntitySeq<Byte> implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 41616357288213283L;
	private Byte seq;
	...
	public MbcDestinoPaciente() {
	}
	
	public MbcDestinoPaciente(Byte seq) {
		this.seq = seq;
	}

	public MbcDestinoPaciente(Byte seq, RapServidores servidor,
	...
	public MbcDestinoPaciente(Byte seq, RapServidores servidorAlterado,
			RapServidores servidor, String descricao, DominioSituacao situacao,
			Date criadoEm, Set<MbcCirurgias> cirurgias) {
		this.seq = seq;
	...
	@Id
//	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mbcDpaSq1")
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "destinoPaciente")
	...
	*/
	...
	public boolean equals(Object obj) {
		...
		MbcDestinoPaciente other = (MbcDestinoPaciente) obj;
		if (seq == null) {
			if (other.seq != null) {
				return false;
			}
