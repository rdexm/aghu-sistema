 ...
 */
@Entity
@SequenceGenerator(name="mcoTrabPartosJn", sequenceName="AGH.mco_tpa_jn_seq", allocationSize = 1)
@Table(name = "MCO_TRAB_PARTOS_JN", schema = "AGH")
@Immutable
public class McoTrabPartosJn extends BaseJournal {
...
/**
	...
	public McoTrabPartosJn() {
	}

	public McoTrabPartosJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short gsoSeqp, Integer gsoPacCodigo) {
	...
	public McoTrabPartosJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Date dthriniCtg, String indicacoesCtg,
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mcoTrabPartosJn")
	@NotNull
	@Override
