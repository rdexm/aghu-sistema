...
/**
 * MpmFichaApacheId generated by hbm2java
 */
@Embeddable

public class MpmFichaApacheId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5100755388139645939L;
	private Integer atdSeq;
	private Short seqp;

	public MpmFichaApacheId() {
	}

	public MpmFichaApacheId(Integer atdSeq, Short seqp) {
		this.atdSeq = atdSeq;
		this.seqp = seqp;
	}
	...
	public boolean equals(Object obj) {
		...
		MpmFichaApacheId other = (MpmFichaApacheId) obj;
		if (atdSeq == null) {
