...
/**
 * MpmAltaDiagSecundariosId generated by hbm2java
 */

@Embeddable
public class MpmAltaDiagSecundarioId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7039864682561820621L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;
	private Short seqp;

	public MpmAltaDiagSecundarioId() {
	}

	public MpmAltaDiagSecundarioId(Integer asuApaAtdSeq, Integer asuApaSeq,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaDiagSecundarioId)) {
			return false;
		}
		MpmAltaDiagSecundarioId castOther = (MpmAltaDiagSecundarioId) other;
