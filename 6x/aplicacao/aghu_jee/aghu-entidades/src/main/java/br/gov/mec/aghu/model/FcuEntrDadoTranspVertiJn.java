...
/**
 * FcuEntrDadoTranspVertiJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_TRANSP_VERTI_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoTranspVertiJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = -2344138078145925473L;
	...
	public FcuEntrDadoTranspVertiJn() {
	}

	public FcuEntrDadoTranspVertiJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuEntrDadoTranspVertiJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtInicioValidade,
