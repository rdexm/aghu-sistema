...
/**
 * MciRefCode generated by hbm2java
 */
@Entity
@Table(name = "MCI_REF_CODES", schema = "AGH")
public class MciRefCode extends BaseEntityId<MciRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4479703280848756738L;
	private MciRefCodeId id;

	public MciRefCode() {
	}

	public MciRefCode(MciRefCodeId id) {
		this.id = id;
	}
	...
	public MciRefCodeId getId() {
		return this.id;
	}

	public void setId(MciRefCodeId id) {
		this.id = id;
	}
