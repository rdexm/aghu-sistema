...
/**
 * AnuRefCode generated by hbm2java
 */
@Entity
@Table(name = "ANU_REF_CODES", schema = "AGH")
public class AnuRefCode extends BaseEntityId<AnuRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6700496316572634439L;
	private AnuRefCodeId id;

	public AnuRefCode() {
	}

	public AnuRefCode(AnuRefCodeId id) {
		this.id = id;
	}
	...
	public AnuRefCodeId getId() {
		return this.id;
	}

	public void setId(AnuRefCodeId id) {
		this.id = id;
	}
