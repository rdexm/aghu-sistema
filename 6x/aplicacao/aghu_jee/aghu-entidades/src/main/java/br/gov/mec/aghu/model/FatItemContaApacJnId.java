...
/**
 * FatItensContaApacJnId generated by hbm2java
 */
@Embeddable
public class FatItemContaApacJnId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3436780701144963029L;
	private Long seqJn;
	...
	public FatItemContaApacJnId() {
	}

	public FatItemContaApacJnId(String jnUser, Date jnDateTime,
	...
	public FatItemContaApacJnId(String jnUser, Date jnDateTime,
			String jnOperation, Long capAtmNumero, Byte capSeqp, Short seqp,
			Short quantidade, String indSituacao, Character localCobranca,
			String criadoPor, Date criadoEm, String alteradoPor,
			Date alteradoEm, BigDecimal valor, Integer phiSeq,
			Integer serMatricula, Short serVinCodigo, Short iseSeqp,
			Integer iseSoeSeq, Integer prhConNumero, Integer prhPhiSeq,
			Date dthrRealizado, Integer ppcCrgSeq, Integer ppcEprPciSeq,
			Short ppcEprEspSeq, String ppcIndRespProc, Long pmrSeq) {
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;
		this.capAtmNumero = capAtmNumero;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FatItemContaApacJnId)) {
			return false;
		}
		FatItemContaApacJnId other = (FatItemContaApacJnId) obj;
