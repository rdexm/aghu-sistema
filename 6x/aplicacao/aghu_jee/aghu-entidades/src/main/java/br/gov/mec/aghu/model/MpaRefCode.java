...
/**
 * MpaRefCode generated by hbm2java
 */
@Entity
@Table(name = "MPA_REF_CODES", schema = "AGH")
public class MpaRefCode extends BaseEntityId<MpaRefCodeId> implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5247095710466945285L;
	private MpaRefCodeId id;

	public MpaRefCode() {
	}

	public MpaRefCode(MpaRefCodeId id) {
		this.id = id;
	}
	...
	public MpaRefCodeId getId() {
		return this.id;
	}

	public void setId(MpaRefCodeId id) {
		this.id = id;
	}
