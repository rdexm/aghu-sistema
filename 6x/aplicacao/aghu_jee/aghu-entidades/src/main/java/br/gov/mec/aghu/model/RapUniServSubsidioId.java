...
/**
 * RapUniServSubsidioId generated by hbm2java
 */
@Embeddable
public class RapUniServSubsidioId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4778218358049400548L;
	private Short sadSerVinCodigo;
	private Integer sadSerMatricula;
	private Short sadSeqp;
	private Date dtInicio;

	public RapUniServSubsidioId() {
	}

	public RapUniServSubsidioId(Short sadSerVinCodigo, Integer sadSerMatricula, Short sadSeqp, Date dtInicio) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniServSubsidioId)) {
			return false;
		}
		RapUniServSubsidioId other = (RapUniServSubsidioId) obj;
