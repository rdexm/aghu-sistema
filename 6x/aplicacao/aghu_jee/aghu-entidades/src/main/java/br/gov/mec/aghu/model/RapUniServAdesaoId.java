...
/**
 * RapUniServAdesaoId generated by hbm2java
 */
@Embeddable
public class RapUniServAdesaoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1201321034995190129L;
	private Integer serMatricula;
	private Short serVinCodigo;
	private Short seqp;

	public RapUniServAdesaoId() {
	}

	public RapUniServAdesaoId(Integer serMatricula, Short serVinCodigo, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniServAdesaoId)) {
			return false;
		}
		RapUniServAdesaoId other = (RapUniServAdesaoId) obj;
