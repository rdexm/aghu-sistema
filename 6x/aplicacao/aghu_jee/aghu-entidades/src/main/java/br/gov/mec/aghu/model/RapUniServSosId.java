...
/**
 * RapUniServSosId generated by hbm2java
 */
@Embeddable
public class RapUniServSosId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3724607942340259680L;
	private Integer sadSerMatricula;
	private Short sadSerVinCodigo;
	private Short sadSeqp;
	private Date dtInicio;

	public RapUniServSosId() {
	}

	public RapUniServSosId(Integer sadSerMatricula, Short sadSerVinCodigo, Short sadSeqp, Date dtInicio) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapUniServSosId)) {
			return false;
		}
		RapUniServSosId other = (RapUniServSosId) obj;
