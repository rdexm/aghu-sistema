...
/**
 * McoLogImpressoesId generated by hbm2java
 */
@Embeddable
public class McoLogImpressoesId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4149126132744666370L;
	private Integer gsoPacCodigo;
	private Short gsoSeqp;
	private Integer seqp;

	public McoLogImpressoesId() {
	}

	public McoLogImpressoesId(Integer gsoPacCodigo, Short gsoSeqp, Integer seqp) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof McoLogImpressoesId)) {
			return false;
		}
		McoLogImpressoesId castOther = (McoLogImpressoesId) other;
