...
/**
 * RapPppFatorRiscoId generated by hbm2java
 */
@Embeddable
public class RapPppFatorRiscoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3517440360945214772L;
	private Integer serMatricula;
	private Short serVinCodigo;
	private Short seqp;

	public RapPppFatorRiscoId() {
	}

	public RapPppFatorRiscoId(Integer serMatricula, Short serVinCodigo, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RapPppFatorRiscoId)) {
			return false;
		}
		RapPppFatorRiscoId other = (RapPppFatorRiscoId) obj;
