...
/**
 * FcuEntrDadoGasoterapiaJn generated by hbm2java
 */
@Entity
@Table(name = "FCU_ENTR_DADOS_GASOTERAPIA_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoGasoterapiaJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 7513437372592713062L;
	...
	public FcuEntrDadoGasoterapiaJn() {
	}

	public FcuEntrDadoGasoterapiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq) {
	...
	public FcuEntrDadoGasoterapiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Integer seq, Date dtInicioValidade,
