...
/**
 * MpmAltaAtendimentosId generated by hbm2java
 */
@Embeddable
public class MpmAltaAtendimentoId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7760007216175642226L;
	private Integer asuApaAtdSeq;
	private Integer asuApaSeq;
	private Short asuSeqp;
	private Integer seqp;

	public MpmAltaAtendimentoId() {
	}

	public MpmAltaAtendimentoId(Integer asuApaAtdSeq, Integer asuApaSeq,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MpmAltaAtendimentoId)) {
			return false;
		}
		MpmAltaAtendimentoId castOther = (MpmAltaAtendimentoId) other;
