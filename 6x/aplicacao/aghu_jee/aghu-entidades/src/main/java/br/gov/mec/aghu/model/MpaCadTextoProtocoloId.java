...
/**
 * MpaCadTextoProtocoloId generated by hbm2java
 */
@Embeddable
public class MpaCadTextoProtocoloId implements EntityCompositeId {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1436750197930112118L;
	private Short vpaPtaSeq;
	private Short vpaSeqp;
	private Short seqp;

	public MpaCadTextoProtocoloId() {
	}

	public MpaCadTextoProtocoloId(Short vpaPtaSeq, Short vpaSeqp, Short seqp) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MpaCadTextoProtocoloId)) {
			return false;
		}
		MpaCadTextoProtocoloId other = (MpaCadTextoProtocoloId) obj;
