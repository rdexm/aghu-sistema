...
@Entity
@Table(name = "FCU_ENTR_DADOS_ENERGIA_JN", schema = "AGH")
@Immutable
public class FcuEntrDadoEnergiaJn extends BaseJournal {

/**
	 * 
	 */
	private static final long serialVersionUID = 2897600598912751467L;
	...
	public FcuEntrDadoEnergiaJn() {
	}

	public FcuEntrDadoEnergiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq) {
	...
	public FcuEntrDadoEnergiaJn(Long seqJn, String jnUser, Date jnDateTime, String jnOperation, Short seq, Date dtInicioValidade,
			Date dtFimValidade, Integer cctCodigo, Double qtConsumo, Date criadoEm, Integer serMatricula, Short serVinCodigo) {
	/* ATUALIZADOR JOURNALS - contrutor	this.seqJn = seqJn;
		this.jnUser = jnUser;
		this.jnDateTime = jnDateTime;
		this.jnOperation = jnOperation;*/
...
/* ATUALIZADOR JOURNALS - Get / Set	@Id
	...
	@Column(name = "QT_CONSUMO", precision = 17, scale = 17)
