...
public class AGHUITextRenderer {
    ...
    private AGHUITextOutputDevice _outputDevice;
    ...
    private AGHUPDFCreationListener _listener;
    
    public AGHUITextRenderer() {
        this(DEFAULT_DOTS_PER_POINT, DEFAULT_DOTS_PER_PIXEL);
    }
    
    public AGHUITextRenderer(float dotsPerPoint, int dotsPerPixel) {
    	_dotsPerPoint = dotsPerPoint;
        
        _outputDevice = new AGHUITextOutputDevice(_dotsPerPoint);
        ...
        AGHUITextFontResolver fontResolver = new AGHUITextFontResolver(_sharedContext);
        ...
        _sharedContext.setTextRenderer(new AGHUITextTextRenderer());
    ...
    public AGHUITextFontResolver getFontResolver() {
        return (AGHUITextFontResolver)_sharedContext.getFontResolver();
    }
    ...
    public AGHUPDFCreationListener getListener() {
        return _listener;
    }

    public void setListener(AGHUPDFCreationListener listener) {
        _listener = listener;
    }
