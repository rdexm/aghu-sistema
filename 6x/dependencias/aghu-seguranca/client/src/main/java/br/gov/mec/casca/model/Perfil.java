...
@SequenceGenerator(name="cscPerfSeq", sequenceName="casca.casca_perfil_sq1")
@Name("perfil")
public class Perfil implements java.io.Serializable {
	...
	@NotNull(message = "Nome do perfil não informado")
	...
	@NotNull(message = "Descrição do perfil não informada")
	...
	@NotNull(message = "Data de criação do perfil não informada")
	...
	@NotNull(message = "Situação do perfil não informada")
